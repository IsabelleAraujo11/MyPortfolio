    ...
    <section id="sobre" className="py-28 bg-white dark:bg-forest-800/30">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          {/* Left: text */}
          <div>
            <p className="section-subtitle">Quem sou eu</p>
            <h2 className="section-title mb-6">Sobre mim</h2>

            <div className="space-y-4 text-forest-600/80 dark:text-cream-200/70 leading-relaxed font-body text-base">
              <p>
          ...
          <div className="space-y-4">
            ...
            {/* Available badge */}
            <div className="card p-5 flex items-center gap-4 mt-2">
